if(NOT BUILD_WITH_QT4)
  ...
  if(NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Windows" AND NOT ${CMAKE_SYSTEM_NAME} STREQUAL "Darwin")
    if(BUILD_WITH_NOTE_EDITOR OR BUILD_WITH_AUTHENTICATION_MANAGER)
      ...
      find_package(Qt4 COMPONENTS QTCORE QTGUI QTNETWORK QTXML QTSQL QTTEST QTDBUS QUIET REQUIRED)
    endif()
  else()
    if(BUILD_WITH_NOTE_EDITOR OR BUILD_WITH_AUTHENTICATION_MANAGER)
      find_package(Qt4 COMPONENTS QTCORE QTGUI QTNETWORK QTWEBKIT QTXML QTSQL QTTEST QUIET REQUIRED)
    else()
      find_package(Qt4 COMPONENTS QTCORE QTGUI QTNETWORK QTXML QTSQL QTTEST QUIET REQUIRED)
    endif()
  endif()
  include(${QT_USE_FILE})
