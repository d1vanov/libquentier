...
if(CLANG_TIDY_BINARY)
  ...
  function(build_clang_tidy_target WITH_AUTO_FIX)
    ...
    foreach(SOURCE IN LISTS ${PROJECT_NAME}_HEADERS ${PROJECT_NAME}_SOURCES TEST_SOURCES TEST_HEADERS)
      ...
      string(APPEND CLANG_TIDY_SCRIPT "echo \"Running clang-tidy on file ${PROJECT_SOURCE_DIR}/${SOURCE}...\"")
      string(APPEND CLANG_TIDY_SCRIPT "${NEWLINE}")

      string(APPEND CLANG_TIDY_SCRIPT "${CLANG_TIDY_BINARY} ${PROJECT_SOURCE_DIR}/${SOURCE}")
