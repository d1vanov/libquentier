...
DatabaseLockFailedException * DatabaseLockFailedException::clone() const
{
    return new DatabaseLockFailedException{errorMessage()};
}

void DatabaseLockFailedException::raise() const
{
    throw *this;
}
