...
DatabaseRequestException * DatabaseRequestException::clone() const
{
    return new DatabaseRequestException{errorMessage()};
}

void DatabaseRequestException::raise() const
{
    throw *this;
}
