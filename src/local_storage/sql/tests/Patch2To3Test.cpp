...
protected:
    ...
    [[nodiscard]] TestData prepareLocalStorageForUpgrade()
    {
        ...
        auto putNotebookFuture =
            notebooksHandler->putNotebook(testData.m_notebook);
        ...
        testData.m_firstResource.setData(qevercloud::Data{});
        {
            ...
            data.setBody(
                QByteArray::fromStdString("test first resource data"s));
            data.setSize(data.body()->size());
            data.setBodyHash(QCryptographicHash::hash(
                *data.body(), QCryptographicHash::Md5));
        }
...

        {
            ...
            data.setBody(
                QByteArray::fromStdString("test second resource data"s));
            data.setSize(data.body()->size());
            data.setBodyHash(QCryptographicHash::hash(
                *data.body(), QCryptographicHash::Md5));
        }
        ...
        testData.m_secondResource.setAlternateData(qevercloud::Data{});
        {
            ...
            data.setBody(QByteArray::fromStdString(
                "test second resource alternate data"s));
...

        {
            ...
            data.setBody(
                QByteArray::fromStdString("test third resource data"s));
            data.setSize(data.body()->size());
            data.setBodyHash(QCryptographicHash::hash(
                *data.body(), QCryptographicHash::Md5));
        }
        ...
        {
            auto & data =
                testData.m_thirdResource.mutableAlternateData().value();
            data.setBody(QByteArray::fromStdString(
                "test third resource alternate data"s));
