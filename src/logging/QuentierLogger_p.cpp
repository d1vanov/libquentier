...
void QuentierLogger::addLogWriter(IQuentierLogWriter * pLogWriter)
{
    ...
    if (pFileLogWriter)
    {
        QObject::connect(
            this,
            &QuentierLogger::sendRestartLoggingRequest,
            pFileLogWriter,
            &QuentierFileLogWriter::restartLogging,
            Qt::QueuedConnection);
    }
