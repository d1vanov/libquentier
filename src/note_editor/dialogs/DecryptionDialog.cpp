    ...
    m_keyLength(keyLength)
{
    ...
    QVariant rememberPassphraseForSessionSetting = appSettings.value(NOTE_EDITOR_REMEMBER_PASSPHRASE_FOR_SESSION_KEY);
...
void DecryptionDialog::onRememberPassphraseStateChanged(int checked)
{
    ...
    if (!appSettings.isWritable()) {
        ...
        appSettings.setValue(NOTE_EDITOR_REMEMBER_PASSPHRASE_FOR_SESSION_KEY,
