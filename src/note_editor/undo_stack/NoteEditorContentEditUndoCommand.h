...
private:
    /**
     * During the editing of the note's content the resources attached to
     ...
     *
     * The undo stack must make it possible to restore the resources when undoing
     * the changes made to the note's content. For this reason each undo command
     * for note content's edit contains a list of note's resources which should
     * be restored back to the note on undoing the edit; most of the time it would
     * be the same unchanged list; thanks to Qt's copy-on-write facilities,
     * the storage and copying of a list with resources for this use case is
     * actually very cheap
     *
