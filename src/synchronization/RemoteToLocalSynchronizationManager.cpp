...
void RemoteToLocalSynchronizationManager::launchSync()
{
    ...
    if (!m_tags.empty() || !m_expungedTags.isEmpty() || !m_notebooks.empty() || !m_expungedNotebooks.isEmpty()) {
...
void RemoteToLocalSynchronizationManager::requestAuthenticationTokensForAllLinkedNotebooks()
{
    ...
    emit requestAuthenticationTokensForLinkedNotebooks(linkedNotebookAuthData);
}
