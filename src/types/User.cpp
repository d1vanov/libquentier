...
bool User::checkParameters(ErrorString & errorDescription) const
{
    ...
    if (!enUser.id.isSet()) {
        errorDescription.setBase(QT_TRANSLATE_NOOP("", "User id is not set"));
        return false;
    }
    ...
    if (enUser.username.isSet())
    {
        ...
        {
            errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's name has invalid size"));
        ...
        if (usernameRegExp.indexIn(username) < 0) {
            errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's name can contain only \"a-z\" or \"0-9\""
    ...
    if (enUser.name.isSet())
    {
        ...
        {
            errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's displayed name has invalid size"));
        ...
        if (nameRegExp.indexIn(name) < 0) {
            errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's displayed name doesn't match its regular expression. "
    ...
    if (enUser.timezone.isSet())
    {
        ...
        {
            errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's timezone has invalid size"));
        ...
        if (timezoneRegExp.indexIn(timezone) < 0) {
            errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's timezone doesn't match its regular expression. "
    ...
    if (enUser.attributes.isSet())
    {
        ...
        if (attributes.defaultLocationName.isSet())
        {
            ...
            {
                errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's default location name has invalid size"));
        ...
        if (attributes.viewedPromotions.isSet())
        {
            ...
            foreach(const QString & viewedPromotion, viewedPromotions)
            {
                ...
                {
                    errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's viewed promotion has invalid size"));
        ...
        if (attributes.incomingEmailAddress.isSet())
        {
            ...
            {
                errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's incoming email address has invalid size"));
        ...
        if (attributes.recentMailedAddresses.isSet())
        {
            ...
            {
                errorDescription.setBase(QT_TRANSLATE_NOOP("", "User recent mailed addresses size is invalid"));
            ...
            foreach(const QString & recentMailedAddress, recentMailedAddresses)
            {
                ...
                {
                    errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's recent emailed address has invalid size"));
        ...
        if (attributes.comments.isSet())
        {
            ...
            {
                errorDescription.setBase(QT_TRANSLATE_NOOP("", "User's comments have invalid size"));
