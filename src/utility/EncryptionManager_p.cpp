                                           ...
                                           ErrorString & errorDescription)
{
    ...
    if (res != 1) {
        ...
        GET_OPENSSL_ERROR;
        QNWARNING(errorDescription
                  << ", openssl PKCS5_PBKDF2_HMAC failed: "
                  << ": lib: " << errorLib
                  << "; func: " << errorFunc
                  << ", reason: " << errorReason);
        return false;
                                             ...
                                             ErrorString & errorDescription)
{
    ...
    if (res != 1) {
        ...
        GET_OPENSSL_ERROR;
        QNWARNING(errorDescription
                  << ", openssl EVP_CipherUpdate failed: "
                  << ": lib: " << errorLib
                  << "; func: " << errorFunc
                  << ", reason: " << errorReason);
        free(cipherText);
    ...
    if (res != 1) {
        ...
        GET_OPENSSL_ERROR;
        QNWARNING(errorDescription
                  << ", openssl EVP_CipherFinal failed: "
                  << ": lib: " << errorLib
                  << "; func: " << errorFunc
                  << ", reason: " << errorReason);
        free(cipherText);
                                          ...
                                          ErrorString & errorDescription)
{
    ...
    if (res != 1)
    {
        ...
        GET_OPENSSL_ERROR;
        QNWARNING(errorDescription
                  << ", openssl EVP_DecryptInit failed: "
                  << ": lib: " << errorLib
                  << "; func: " << errorFunc
                  << ", reason: " << errorReason);
        free(decipheredText);
    ...
    if (res != 1)
    {
        ...
        GET_OPENSSL_ERROR;
        QNWARNING(errorDescription
                  << ", openssl EVP_DecryptUpdate failed: "
                  << ": lib: " << errorLib
                  << "; func: " << errorFunc
                  << ", reason: " << errorReason);
        free(decipheredText);
    ...
    if (res != 1)
    {
        ...
        GET_OPENSSL_ERROR;
        QNWARNING(errorDescription
                  << ", openssl EVP_DecryptFinal failed: "
                  << ": lib: " << errorLib
                  << "; func: " << errorFunc
                  << ", reason: " << errorReason);
        free(decipheredText);
                                                  ...
                                                  ErrorString & errorDescription)
{
    ...
    if (encryptedDataSize <= minLength)
    {
        ...
        QNWARNING(errorDescription << ": " << encryptedDataSize
                  << " bytes while should be at least "
                  << minLength << " bytes");
        return false;
    }
