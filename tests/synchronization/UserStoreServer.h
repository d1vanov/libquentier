...
public:
    ...
    [[nodiscard]] std::optional<qevercloud::AccountLimits> findAccountLimits(
    ...
    void removeAccountLimits(qevercloud::ServiceLevel serviceLevel);

    [[nodiscard]] std::optional<qevercloud::User> findUser(
...
Q_SIGNALS:
    ...
    void getAccountLimitsRequestReady(
        qevercloud::AccountLimits, std::exception_ptr e);
...
private Q_SLOTS:
    ...
    void onGetAccountLimitsRequest(
        qevercloud::ServiceLevel serviceLevel,
...
private:
    ...
    QHash<QString, qevercloud::User> m_users;
};
